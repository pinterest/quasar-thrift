...
import com.pinterest.example.thrift.ExampleException;
...
public class ExampleServiceImpl implements ExampleService.Iface {
  @Override
  @Suspendable
  public ExampleResponse example(ExampleRequest request) throws ExampleException, TException {
    return new ExampleResponse().setMessage("hello, world");
  }
}
